   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "      <td>NaN</td>\n",
       "      <td>116129.0</td>\n",
       "      <td>calling accountant bookkeeper looking delight ...</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>1</th>\n",
       "      <td>1656947523213303810</td>\n",
       ...
       "      <td>NaN</td>\n",
       "      <td>122.0</td>\n",
       "      <td>wonderful partner showing easy pay employee ð...</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>2</th>\n",
       "      <td>1654499440172883969</td>\n",
       ...
       "      <td>NaN</td>\n",
       "      <td>206.0</td>\n",
       "      <td>rt brilliant panel covering next week elise sa...</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>3</th>\n",
       "      <td>1651865485732978689</td>\n",
       ...
       "      <td>NaN</td>\n",
       "      <td>886.0</td>\n",
       "      <td>rt digitalfirst practice look like like weve m...</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>4</th>\n",
       "      <td>1651154177748262913</td>\n",
       ...
       "      <td>NaN</td>\n",
       "      <td>161.0</td>\n",
       "      <td>exhibiting london â­ï¸ book free ticket toda...</td>\n",
       "    </tr>\n",
       "  </tbody>\n",
       "</table>\n",
      ...
      "text/plain": [
       ...
       "4                     NaN                   NaN                      NaN   \n",
       "\n",
       "  user_mentions/15/screen_name user_mentions/16/id_str user_mentions/16/name  \\\n",
       "0                          NaN                     NaN                   NaN   \n",
       "1                          NaN                     NaN                   NaN   \n",
       "2                          NaN                     NaN                   NaN   \n",
       "3                          NaN                     NaN                   NaN   \n",
       "4                          NaN                     NaN                   NaN   \n",
       "\n",
       "   user_mentions/16/profile  user_mentions/16/screen_name  view_count  \\\n",
       "0                       NaN                           NaN    116129.0   \n",
       "1                       NaN                           NaN       122.0   \n",
       "2                       NaN                           NaN       206.0   \n",
       "3                       NaN                           NaN       886.0   \n",
       ...
       "\n",
       "                                    Processed_Tweets  \n",
       "0  calling accountant bookkeeper looking delight ...  \n",
       "1  wonderful partner showing easy pay employee ð...  \n",
       "2  rt brilliant panel covering next week elise sa...  \n",
       "3  rt digitalfirst practice look like like weve m...  \n",
       "4  exhibiting london â­ï¸ book free ticket toda...  \n",
       "\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "0  calling accountant bookkeeper looking delight ...  0.300000      0.800000   \n",
       "1  wonderful partner showing easy pay employee ð...  0.716667      0.916667   \n",
       "\n",
       "   Sentiment  \n",
       "0   Positive  \n",
       "1   Positive  \n",
